...
- Total candidates reviewed: 59 (50 prior + **9 iter-021 follow-ups (#45/#46/#47/#48/#49/#50/#51/#52 agent-generated + #53 coordinator-generated during retracted scope expansion)**; iter 018 added zero new rows; iter 019 closed **#15** with 0 new; iter 020 closed 0 / added 3; iter 021 closed 0 / added 9)
- Top priority area: **iter 022 = Mode 5 item 5/5 — accessibility + polish + E2E** per `PRD_DASHBOARD_V2.md` §9 + §10 + §14. Primary agents: qa-engineer (lead) + frontend-engineer (polish support). Deliverables: WCAG AA audit (contrast, keyboard, screen reader, aria-sort/aria-label correctness on health score cells); Playwright E2E covering all 5 UI states (loading/empty/no-results/error/sparse/ready); D1 auto-redirect activation (per rollout §14 iter-022-close) or explicit deferral; polish candidates from iter-021 follow-up pool (#47 Suspense wrap, #49 kebab wiring, #50 D7 annotation, #51 v2 analytics instrumentation — subject to qa-engineer scope bounding). Entry gate: iter 021 UI validation green (✅ confirmed typecheck clean + web-app 11 files / 233 tests passing + honest-dimension-label grep clean + no v1 regressions).
- Open follow-up pool (Birth iter shown): #7 (008, age 13) · **#14 (007, age 14 — past staleness cap, KEEP per MR-004 Agenda 3, target post-Path-B iter 023+)** · ~~#15 (006 — closed iter 019)~~ · #19/20/21 (010) · #23/24 (011) · #26 (012) · #27/28 (M3@012) · #29/30 (013) · #31/32 (014) · #34/35/36 (audit-intake P0) · #37/38/39 (M3@016 follow-ups) · **#40 (PRD-promoted BUG-07)** · **#41 (iter 017 follow-up)** · **#42/#43/#44 (iter 020 follow-ups)** · **#45/#46/#47/#48/#49/#50/#51/#52 (iter 021 agent-generated follow-ups)** · **#53 (iter 021 coordinator-generated follow-up from retracted scope expansion — workspace vitest `.test.tsx` discovery gap)** — **34 items open** (25 at iter 020 close − 0 closed − 0 expanded + 9 new generated at iter 021 = 34; **pool-size ceiling rule is deeply violated** — MR-005 at iter 023 boundary MUST triage aggressively; iter 022 proceeds only via Mode 5 operating-mode precedence + companion-burn-down already discharged at iter 019)
...
| 47 | Wrap `DashboardPage` (or the `(app)` layout) in `<Suspense>` boundary so `useSearchParams()` in the client `DashboardV2Shell` path does not trigger Next.js 14 warning — layout-level fix; dev-only console warning today, no render breakage | fix | web-app / Next.js hygiene | 2 | 3 | 1 | 5 | 1 | 1 | **9** | 021 | new (iter 021 follow-up — candidate for iter 022 polish window; trivial layout wrap) |
| 48 | Activate `?v2=1` auto-redirect per PRD D1 rollout §14 (all users redirect to v2 at iter 022 close); follow-up removal of flag after 14-day soak per D1 post-launch commitment | improvement | rollout / dashboard-v2 | 4 | 5 | 2 | 5 | 1 | 2 | **13** | 021 | new (iter 021 follow-up — PRD D1 contractual commitment; iter 022 or immediately post-iter-022 activation; tracking row so commitment does not silently drop) |
| 49 | Wire `WorkflowRow` kebab menu "Edit name" + "Archive" to backend — requires `PATCH /api/workflows/[id]` endpoint pattern (may already exist; audit first). Currently menu items present and keyboard-accessible but no-op on click | improvement | dashboard-v2 / feature completion | 3 | 3 | 1 | 4 | 2 | 2 | **7** | 021 | new (iter 021 follow-up — stubbed UI per scope; candidate for iter 022 polish) |
| 50 | Add "(all-time)" annotation to Runs subtext in `WorkflowRow` when time range filter ≠ "All" — per PRD D7 honesty about UI-only scoping; currently subtext renders raw count without annotation, implying time-range-scoped runs when they are all-time | fix | dashboard-v2 / honest-labels | 2 | 4 | 1 | 5 | 1 | 1 | **10** | 021 | new (iter 021 follow-up — small trust-first correction; candidate for iter 022 polish) |
...
| 52 | `PortfolioSidebar` integration with v2 shell per PRD D5 — collapse-by-default + "Portfolios" icon button in `WorkflowListFilterBar` that toggles sidebar visibility; not in core 8-component scope for iter 021 | improvement | dashboard-v2 / PRD D5 | 2 | 3 | 1 | 4 | 2 | 1 | **7** | 021 | new (iter 021 follow-up — D5 contractual commitment; candidate for iter 022 polish or post-Path-B follow-up iteration) |
