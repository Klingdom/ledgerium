...
<body>
  ...
  <div class="stats">
    ...
    <div class="stat"><div class="value">${formatMsForReport(metrics.activeDurationMs)}</div><div class="label">Active Time</div></div>
    <div class="stat"><div class="value">${formatMsForReport(metrics.idleDurationMs)}</div><div class="label">Idle Time</div></div>
  </div>
  <div class="stats">
