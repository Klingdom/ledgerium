    ...
    <>
      ...
      <section className="pt-20 pb-10 bg-gradient-to-b from-brand-900/20 to-[var(--surface-primary)]">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="mt-4 text-lg text-[var(--content-secondary)]">
            ...
            {PRICING_CONFIG.plans.map((plan) => (
              ...
              >
                ...
                <div className="mb-5">
                  ...
                  <p className="text-xs text-[var(--content-secondary)] mt-1 leading-relaxed">{plan.description}</p>
                </div>
                ...
                <ul className="space-y-2.5 flex-1">
                  ...
                  {plan.limits.map((limit) => (
                    <li key={limit} className="flex items-start gap-2 opacity-40">
                      ...
                      <span className="text-xs text-[var(--content-secondary)] leading-relaxed">{limit}</span>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-20 bg-[var(--surface-elevated)] border-t border-[var(--border-subtle)]">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="mt-3 text-ds-xs text-[var(--content-secondary)]">
