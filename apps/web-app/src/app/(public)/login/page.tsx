    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-[#b0bec9]">Sign in to your workflow workspace</p>
        </div>

        <p className="text-center text-ds-xs text-[#b0bec9] mb-4">
        ...
        <p className="mt-4 text-center text-sm text-[#b0bec9]">
          No account?{' '}
