    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-[var(--content-primary)]">Sign in to your workflow workspace</p>
        </div>

        <p className="text-center text-ds-xs text-[var(--content-primary)] mb-4">
          <span className="inline-flex items-center gap-1.5">
            <svg className="h-3.5 w-3.5 text-[var(--brand-text)]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          {error && (
            <div className="rounded-lg bg-red-900/20 border border-red-700/40 p-3 text-sm text-[var(--status-danger)]">{error}</div>
          )}
          ...
          <div className="text-right">
            <Link href="/forgot-password" className="text-xs text-[var(--brand-text)] hover:text-[var(--brand-text-hover)]">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="mt-4 text-center text-sm text-[var(--content-primary)]">
          No account?{' '}
          <Link href="/signup" className="font-medium text-[var(--brand-text)] hover:text-[var(--brand-text-hover)]">
            Sign up free
          </Link>
        </p>
      </div>
