    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-[var(--content-primary)]">Create your workflow workspace</p>
        </div>
        ...
        <div className="mt-8 px-1">
          ...
          <ol className="space-y-4">
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 inline-flex items-center justify-center bg-brand-900/20 text-[var(--brand-text)] rounded-full w-6 h-6 text-xs font-semibold mt-0.5">
                1
              </span>
              <div>
