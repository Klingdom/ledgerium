  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="mx-auto max-w-md">
        ...
        <h2 className="mt-4 text-lg font-semibold text-[var(--content-primary)]">Something went wrong</h2>
        ...
        {error.digest && (
          <p className="mt-4 text-xs text-[var(--content-tertiary)]">Error ID: {error.digest}</p>
        )}
      </div>
    </div>
  );
